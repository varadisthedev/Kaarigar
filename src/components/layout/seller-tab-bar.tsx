...
import { Home, Package, Plus, Users, ShoppingBag } from "lucide-react"
import { useTranslations } from "next-intl"

import { Link, usePathname } from "@/i18n/navigation"
import { cn } from "@/lib/utils"

/** The app-wide bottom bar — Home/Products/Buyers/Orders, with a plus
 * button (not a mic) as the center action. Voice capture still lives inside
 * the Add Product flow itself; this button is just the entry point into it,
 * not a replacement for it. Renders on `/` (the main entry point) and every
 * `/sell/*` page — protected links (Products/Orders/the + button) just
 * redirect to login for a guest, same as any other gated route. */
